(define (problem trace_Alignment_Problem_14_Noisy.pddl)
	(:domain traceAlignment)

	(:objects
		t0 t1 t2 t3 t4 t5 t6 t7 t8 t9 t10 t11 t12 t13 t14 t15 t16 t17 t18 - trace_state
		s0 s1 s2 s3 - automaton_state
		Handle_Case Inbound_Call Call_Outbound Make_credit_offer Check_credit_history Handle_Email Inbound_Email Assess_application Credit_application_processed Credit_application_received - activity
		Handle_Case_assign Handle_Case_start Handle_Case_complete Inbound_Call_assign Inbound_Call_start Inbound_Call_complete Call_Outbound_assign Call_Outbound_start Call_Outbound_complete Make_credit_offer_assign Make_credit_offer_start Make_credit_offer_complete Check_credit_history_assign Check_credit_history_start Check_credit_history_complete Handle_Email_assign Handle_Email_start Handle_Email_complete Inbound_Email_assign Inbound_Email_start Inbound_Email_complete Assess_application_assign Assess_application_start Assess_application_complete Credit_application_processed_assign Credit_application_processed_start Credit_application_processed_complete Credit_application_received_assign Credit_application_received_start Credit_application_received_complete - lifecycle_activity
	)
	...
	(:init
		...
		(trace t4 Handle_Email_assign t5)
		...
		(trace t5 Handle_Email_assign t6)
		...
		(trace t8 Call_Outbound_start t9)
		...
		(trace t11 Inbound_Email_complete t12)
		(trace t12 Handle_Case_assign t13)
		(trace t13 Credit_application_processed_assign t14)
		...
		(trace t14 Credit_application_processed_complete t15)
		(trace t15 Credit_application_received_assign t16)
		...
		(trace t16 Credit_application_received_complete t17)
		(trace t17 Inbound_Call_assign t18)
		(final_state t18)
	)
