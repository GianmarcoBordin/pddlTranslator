(define (problem trace_Alignment_Problem_Case_1_Noisy.pddl)
	...
	(:init
		...
		(cur_state t0)
		(trace t0 Call_Outbound_assign t1)
		(trace t1 Call_Outbound_assign t2)
		(trace t2 Inbound_Call_assign t3)
		(trace t3 Inbound_Call_complete t4)
		(trace t4 Call_Outbound_assign t5)
		(trace t5 Call_Outbound_start t6)
		(trace t6 Handle_Case_assign t7)
		(trace t7 Handle_Case_start t8)
		(trace t8 Call_Outbound_assign t9)
		(trace t9 Call_Outbound_complete t10)
		(final_state t10)
	)
