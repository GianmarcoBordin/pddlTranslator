(define (problem trace_Alignment_Problem_30_Noisy.pddl)
	...
	(:objects
		...
		Handle_Case Inbound_Call Call_Outbound Check_income_sources Check_credit_history Assess_application Inbound_Email Make_credit_offer Handle_Email Credit_application_processed - activity
		Handle_Case_assign Handle_Case_start Handle_Case_complete Inbound_Call_assign Inbound_Call_start Inbound_Call_complete Call_Outbound_assign Call_Outbound_start Call_Outbound_complete Check_income_sources_assign Check_income_sources_start Check_income_sources_complete Check_credit_history_assign Check_credit_history_start Check_credit_history_complete Assess_application_assign Assess_application_start Assess_application_complete Inbound_Email_assign Inbound_Email_start Inbound_Email_complete Make_credit_offer_assign Make_credit_offer_start Make_credit_offer_complete Handle_Email_assign Handle_Email_start Handle_Email_complete Credit_application_processed_assign Credit_application_processed_start Credit_application_processed_complete - lifecycle_activity
	)
	...
	(:init
		...
		(lifecycle completed_state Check_income_sources_assign sink_state)
		...
		(trace t1 Check_income_sources_complete t2)
		(trace t2 Handle_Case_start t3)
		(trace t3 Check_income_sources_start t4)
		(trace t4 Check_credit_history_assign t5)
		...
		(lifecycle completed_state Check_credit_history_assign sink_state)
		...
		(trace t6 Assess_application_assign t7)
		...
		(lifecycle completed_state Assess_application_assign sink_state)
		...
		(trace t7 Assess_application_complete t8)
		(trace t8 Assess_application_start t9)
		(trace t9 Inbound_Email_assign t10)
		...
		(trace t10 Inbound_Email_start t11)
		(trace t11 Inbound_Email_start t12)
		(trace t12 Make_credit_offer_assign t13)
		...
		(lifecycle completed_state Make_credit_offer_assign sink_state)
		...
		(trace t15 Handle_Email_assign t16)
		...
		(trace t16 Handle_Email_complete t17)
		(trace t17 Call_Outbound_start t18)
		(trace t18 Handle_Case_assign t19)
		(trace t19 Credit_application_processed_assign t20)
		...
		(lifecycle completed_state Credit_application_processed_assign sink_state)
		...
		(trace t20 Credit_application_processed_complete t21)
		(trace t21 Handle_Case_complete t22)
