(define (problem trace_Alignment_Problem_Case_6_Noisy.pddl)
	...
	(:init
		...
		(trace t3 Inbound_Call_start t4)
		(trace t4 Inbound_Call_complete t5)
		(trace t5 Inbound_Call_start t6)
		(trace t6 Inbound_Call_complete t7)
		(final_state t7)
	)
