(define (problem trace_Alignment_Problem_40_Noisy.pddl)
	...
	(:init
		...
		(trace t2 Check_income_sources_complete t3)
		(trace t3 Call_Outbound_start t4)
		...
		(trace t6 Inbound_Call_start t7)
		(trace t7 Inbound_Call_start t8)
		...
		(trace t10 Handle_Case_assign t11)
		(trace t11 Inbound_Email_assign t12)
		...
		(trace t12 Inbound_Email_start t13)
		(trace t13 Notify_rejection_assign t14)
		...
		(trace t14 Notify_rejection_complete t15)
		(trace t15 Notify_rejection_start t16)
		(trace t16 Handle_Case_assign t17)
		(trace t17 Assess_application_complete t18)
		(trace t18 Assess_application_start t19)
		(trace t19 Handle_Case_complete t20)
		(trace t20 Handle_Case_complete t21)
		(trace t21 Receive_customer_feedback_assign t22)
		...
		(trace t22 Receive_customer_feedback_complete t23)
		(trace t23 Inbound_Call_assign t24)
		(trace t24 Make_credit_offer_assign t25)
		...
		(trace t25 Make_credit_offer_complete t26)
		(trace t26 Inbound_Call_complete t27)
		(trace t27 Call_Outbound_complete t28)
		(trace t28 Credit_application_processed_assign t29)
		...
		(trace t29 Credit_application_processed_complete t30)
		(final_state t30)
	)
