...
:precondition (and (currstate t13) (not (currstate s_0_3)) (not (currstate s_2_2)) (not (currstate s_0_2)) (not (currstate s_2_3)) (not (currstate s_1_2)) (not (currstate s_1_3)) )
...
:precondition (and (currstate t16) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_3)) (not (currstate s_2_3)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t19) (not (currstate s_0_3)) (not (currstate s_2_2)) (not (currstate s_0_2)) (not (currstate s_2_3)) (not (currstate s_1_2)) (not (currstate s_1_3)) )
