...
:precondition (and (currstate t11) (currstate s_5_3) )
...
(:action sync-p11complete-ct31
:precondition (and (currstate t10) (currstate s_2_3) )
...
:precondition (and (currstate t13) (currstate s_7_3) )
...
:precondition (and (currstate t5) (currstate s_4_3) )
...
:precondition (and (currstate t1) (currstate s_1_3) )
...
:precondition (and (currstate t14) (currstate s_8_3) )
...
:precondition (and (currstate t12) (currstate s_6_3) )
:effect (and (not (currstate t12)) (currstate t13) (not (currstate s_6_3)) (currstate s_6_4) )
)

(:action sync-p18complete-t0t1
:precondition (and (currstate t0) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_4)) (not (currstate s_0_0)) )
:effect (and (not (currstate t0)) (currstate t1)))

(:action del-p18complete-t0-t1
:precondition (currstate t0)
:effect (and (not (currstate t0)) (currstate t1)  (increase (total-cost) 1))
)

(:action sync-p22complete-t1t2
:precondition (and (currstate t1) (not (currstate s_1_2)) (not (currstate s_1_4)) (not (currstate s_1_3)) (not (currstate s_1_0)) )
:effect (and (not (currstate t1)) (currstate t2)))

(:action del-p22complete-t1-t2
:precondition (currstate t1)
:effect (and (not (currstate t1)) (currstate t2)  (increase (total-cost) 1))
)

(:action sync-p11complete-t2t3
:precondition (and (currstate t2) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
:effect (and (not (currstate t2)) (currstate t3)))

(:action del-p11complete-t2-t3
:precondition (currstate t2)
:effect (and (not (currstate t2)) (currstate t3)  (increase (total-cost) 1))
)

(:action sync-p11complete-t3t4
:precondition (and (currstate t3) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
...
(:action sync-p2complete-t4t5
:precondition (and (currstate t4) (not (currstate s_3_0)) (not (currstate s_3_4)) (not (currstate s_3_2)) (not (currstate s_3_3)) )
:effect (and (not (currstate t4)) (currstate t5)))

(:action del-p2complete-t4-t5
:precondition (currstate t4)
:effect (and (not (currstate t4)) (currstate t5)  (increase (total-cost) 1))
)

(:action sync-p8complete-t5t6
:precondition (and (currstate t5) (not (currstate s_4_3)) (not (currstate s_4_0)) (not (currstate s_4_4)) (not (currstate s_4_2)) )
:effect (and (not (currstate t5)) (currstate t6)))

(:action del-p8complete-t5-t6
:precondition (currstate t5)
:effect (and (not (currstate t5)) (currstate t6)  (increase (total-cost) 1))
)

(:action sync-p11complete-t6t7
:precondition (and (currstate t6) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
:effect (and (not (currstate t6)) (currstate t7)))

(:action del-p11complete-t6-t7
:precondition (currstate t6)
:effect (and (not (currstate t6)) (currstate t7)  (increase (total-cost) 1))
)

(:action sync-p11complete-t7t8
:precondition (and (currstate t7) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
:effect (and (not (currstate t7)) (currstate t8)))

(:action del-p11complete-t7-t8
:precondition (currstate t7)
:effect (and (not (currstate t7)) (currstate t8)  (increase (total-cost) 1))
)

(:action sync-p11complete-t8t9
:precondition (and (currstate t8) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
...
(:action sync-p11complete-t10t11
:precondition (and (currstate t10) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
:effect (and (not (currstate t10)) (currstate t11)))

(:action del-p11complete-t10-t11
:precondition (currstate t10)
:effect (and (not (currstate t10)) (currstate t11)  (increase (total-cost) 1))
)

(:action sync-p4complete-t11t12
:precondition (and (currstate t11) (not (currstate s_5_3)) (not (currstate s_5_0)) (not (currstate s_5_4)) (not (currstate s_5_2)) )
:effect (and (not (currstate t11)) (currstate t12)))

(:action del-p4complete-t11-t12
:precondition (currstate t11)
:effect (and (not (currstate t11)) (currstate t12)  (increase (total-cost) 1))
)

(:action sync-p10complete-t12t13
:precondition (and (currstate t12) (not (currstate s_6_3)) (not (currstate s_6_0)) (not (currstate s_6_4)) (not (currstate s_6_2)) )
:effect (and (not (currstate t12)) (currstate t13)))

(:action del-p10complete-t12-t13
:precondition (currstate t12)
:effect (and (not (currstate t12)) (currstate t13)  (increase (total-cost) 1))
)

(:action sync-p13complete-t13t14
:precondition (and (currstate t13) (not (currstate s_7_2)) (not (currstate s_7_4)) (not (currstate s_7_3)) (not (currstate s_7_0)) )
:effect (and (not (currstate t13)) (currstate t14)))

(:action del-p13complete-t13-t14
:precondition (currstate t13)
:effect (and (not (currstate t13)) (currstate t14)  (increase (total-cost) 1))
)

(:action sync-p5complete-t14t15
:precondition (and (currstate t14) (not (currstate s_8_4)) (not (currstate s_8_2)) (not (currstate s_8_3)) (not (currstate s_8_0)) )
:effect (and (not (currstate t14)) (currstate t15)))

(:action del-p5complete-t14-t15
:precondition (currstate t14)
:effect (and (not (currstate t14)) (currstate t15)  (increase (total-cost) 1))
)

(:action sync-p11complete-t15t16
:precondition (and (currstate t15) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
:effect (and (not (currstate t15)) (currstate t16)))

(:action del-p11complete-t15-t16
:precondition (currstate t15)
:effect (and (not (currstate t15)) (currstate t16)  (increase (total-cost) 1))
)

(:action sync-p11complete-t16t17
:precondition (and (currstate t16) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
:effect (and (not (currstate t16)) (currstate t17)))

(:action del-p11complete-t16-t17
:precondition (currstate t16)
:effect (and (not (currstate t16)) (currstate t17)  (increase (total-cost) 1))
)

(:action sync-p11complete-t17t18
:precondition (and (currstate t17) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
:effect (and (not (currstate t17)) (currstate t18)))

(:action del-p11complete-t17-t18
:precondition (currstate t17)
:effect (and (not (currstate t17)) (currstate t18)  (increase (total-cost) 1))
)

(:action sync-p11complete-t18t19
:precondition (and (currstate t18) (not (currstate s_2_0)) (not (currstate s_2_4)) (not (currstate s_2_2)) (not (currstate s_2_3)) )
