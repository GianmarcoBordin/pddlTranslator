...
(:action sync-activitypcomplete-ct0
...
(:action sync-activityncomplete-ct12
...
:precondition (and (currstate t3) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_4)) (not (currstate s_0_0)) )
...
:precondition (and (currstate t7) (not (currstate s_11_0)) (not (currstate s_11_2)) (not (currstate s_11_4)) (not (currstate s_11_3)) )
...
:precondition (and (currstate t8) (not (currstate s_12_0)) (not (currstate s_12_4)) (not (currstate s_12_2)) (not (currstate s_12_3)) )
...
:precondition (and (currstate t17) (not (currstate s_15_3)) (not (currstate s_15_0)) (not (currstate s_15_4)) (not (currstate s_15_2)) )
