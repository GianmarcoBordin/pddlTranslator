...
:precondition (and (currstate t4) (currstate s_13_3) )
...
(:action sync-activityocomplete-t4t5
:precondition (and (currstate t4) (not (currstate s_13_3)) (not (currstate s_13_4)) (not (currstate s_13_0)) (not (currstate s_13_2)) )
:effect (and (not (currstate t4)) (currstate t5)))

(:action del-activityocomplete-t4-t5
...
(:action sync-p20complete-t6t7
:precondition (and (currstate t6) (not (currstate s_15_3)) (not (currstate s_15_0)) (not (currstate s_15_4)) (not (currstate s_15_2)) )
:effect (and (not (currstate t6)) (currstate t7)))

(:action del-p20complete-t6-t7
...
(:action sync-p5complete-t8t9
:precondition (and (currstate t8) (not (currstate s_8_4)) (not (currstate s_8_2)) (not (currstate s_8_3)) (not (currstate s_8_0)) )
:effect (and (not (currstate t8)) (currstate t9)))

(:action del-p5complete-t8-t9
:precondition (currstate t8)
:effect (and (not (currstate t8)) (currstate t9)  (increase (total-cost) 1))
)

(:action sync-p22complete-t9t10
...
(:action sync-p20complete-t11t12
:precondition (and (currstate t11) (not (currstate s_15_3)) (not (currstate s_15_0)) (not (currstate s_15_4)) (not (currstate s_15_2)) )
:effect (and (not (currstate t11)) (currstate t12)))

(:action del-p20complete-t11-t12
...
(:action del-p18complete-t14-t15
...
(:action del-p3complete-t18-t19
:precondition (currstate t18)
:effect (and (not (currstate t18)) (currstate t19)  (increase (total-cost) 1))
)

(:action sync-p22complete-t19t20
:precondition (and (currstate t19) (not (currstate s_1_2)) (not (currstate s_1_4)) (not (currstate s_1_3)) (not (currstate s_1_0)) )
:effect (and (not (currstate t19)) (currstate t20)))

(:action del-p22complete-t19-t20
