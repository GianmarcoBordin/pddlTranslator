...
:precondition (and (currstate t9) (not (currstate s_16_2)) (not (currstate s_16_3)) (not (currstate s_16_0)) (not (currstate s_16_4)) )
...
:precondition (and (currstate t10) (not (currstate s_5_3)) (not (currstate s_5_0)) (not (currstate s_5_4)) (not (currstate s_5_2)) )
...
:precondition (and (currstate t11) (not (currstate s_8_4)) (not (currstate s_8_2)) (not (currstate s_8_3)) (not (currstate s_8_0)) )
...
:precondition (and (currstate t12) (not (currstate s_9_2)) (not (currstate s_9_3)) (not (currstate s_9_4)) (not (currstate s_9_0)) )
