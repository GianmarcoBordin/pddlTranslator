...
:effect (and (not (currstate t10)) (currstate t11) (not (currstate s_0_0)) (currstate s_0_1) )
)
...
:effect (and (not (currstate t10)) (currstate t11) (not (currstate s_0_7)) (currstate s_0_1) )
)
...
:effect (and (not (currstate t10)) (currstate t11) (not (currstate s_0_3)) (currstate s_0_6) )
)
...
(:action sync-activityr-t9t10
:precondition (currstate t9) 
:effect (and (not (currstate t9)) (currstate t10)))

(:action del-activityr-t9-t10
:precondition (currstate t9)
:effect (and (not (currstate t9)) (currstate t10)  (increase (total-cost) 1))
)

(:action sync-p4-t10t11
:precondition (and (currstate t10) (not (currstate s_0_4)) (not (currstate s_0_11)) (not (currstate s_0_0)) (not (currstate s_0_10)) (not (currstate s_0_13)) (not (currstate s_0_7)) (not (currstate s_0_9)) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_8)) (not (currstate s_0_12)) )
:effect (and (not (currstate t10)) (currstate t11)))

(:action del-p4-t10-t11
:precondition (currstate t10)
:effect (and (not (currstate t10)) (currstate t11)  (increase (total-cost) 1))
)

(:action sync-p5-t11t12
:precondition (and (currstate t11) (not (currstate s_0_10)) (not (currstate s_0_2)) (not (currstate s_0_8)) (not (currstate s_0_9)) (not (currstate s_0_12)) (not (currstate s_0_11)) (not (currstate s_0_4)) (not (currstate s_0_7)) (not (currstate s_0_13)) )
:effect (and (not (currstate t11)) (currstate t12)))

(:action del-p5-t11-t12
:precondition (currstate t11)
:effect (and (not (currstate t11)) (currstate t12)  (increase (total-cost) 1))
)

(:action sync-p3-t12t13
:precondition (and (currstate t12) (not (currstate s_0_4)) (not (currstate s_0_11)) (not (currstate s_0_10)) (not (currstate s_0_13)) (not (currstate s_0_7)) (not (currstate s_0_9)) (not (currstate s_0_2)) (not (currstate s_0_8)) (not (currstate s_0_12)) )
:effect (and (not (currstate t12)) (currstate t13)))

(:action del-p3-t12-t13
