...
(:action sync-activityn-t9t10
:precondition (and (currstate t9) (not (currstate s_0_7)) (not (currstate s_0_9)) (not (currstate s_0_10)) (not (currstate s_0_11)) (not (currstate s_0_4)) (not (currstate s_0_2)) (not (currstate s_0_8)) (not (currstate s_0_12)) (not (currstate s_0_13)) )
:effect (and (not (currstate t9)) (currstate t10)))

(:action del-activityn-t9-t10
