...
:precondition (and (currstate t2) (currstate s_1_2) (not (currstate s_0_2)) )
...
:precondition (and (currstate t2) (not (currstate s_1_0)) (not (currstate s_0_2)) (not (currstate s_1_2)) )
