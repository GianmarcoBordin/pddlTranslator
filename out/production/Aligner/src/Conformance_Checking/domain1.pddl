...
:precondition (and (currstate t19) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_0)) )
...
:precondition (and (currstate t19) (currstate s_2_2) (not (currstate s_1_2)) (not (currstate s_1_0)) )
...
:precondition (and (currstate t19) (currstate s_1_2) (currstate s_2_2) )
...
:precondition (and (currstate t19) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_2_0)) )
