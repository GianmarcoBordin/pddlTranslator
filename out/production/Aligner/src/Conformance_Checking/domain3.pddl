...
:precondition (and (currstate t4) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_0_3)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t11) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t14) (not (currstate s_2_2)) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_0_3)) )
