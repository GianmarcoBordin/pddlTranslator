...
:precondition (and (currstate t12) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_0)) )
...
:precondition (and (currstate t12) (currstate s_2_2) (not (currstate s_1_2)) (not (currstate s_1_0)) )
...
:precondition (and (currstate t12) (currstate s_1_2) (currstate s_2_2) )
:effect (and (not (currstate t12)) (currstate t13) (not (currstate s_1_2)) (currstate s_1_0) (not (currstate s_2_2)) (currstate s_2_0) )
)
...
:precondition (and (currstate t12) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_2_0)) )
