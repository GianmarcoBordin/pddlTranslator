...
(:action sync-activityn_complete-ct64
:precondition (and (currstate t9) (currstate s_12_3) )
:effect (and (not (currstate t9)) (currstate t10) (not (currstate s_12_3)) (currstate s_12_0) )
)
...
:precondition (and (currstate t9) (not (currstate s_12_0)) (not (currstate s_12_2)) (not (currstate s_12_3)) )
