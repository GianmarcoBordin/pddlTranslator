...
:precondition (and (currstate t9) (not (currstate s_5_2)) (not (currstate s_6_2)) (not (currstate s_14_2)) (not (currstate s_12_2)) (not (currstate s_13_2)) (not (currstate s_10_2)) (not (currstate s_11_2)) (not (currstate s_0_2)) (not (currstate s_9_2)) (not (currstate s_7_2)) (not (currstate s_8_2)) (not (currstate s_1_2)) (not (currstate s_3_2)) (not (currstate s_4_2)) )
