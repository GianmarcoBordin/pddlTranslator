...
:precondition (and (currstate t2) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t4) (not (currstate s_0_0)) (not (currstate s_0_3)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t6) (not (currstate s_0_0)) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t12) (not (currstate s_0_2)) (not (currstate s_0_0)) (not (currstate s_0_3)) )
