...
(:action sync-p3_complete-ct6
:precondition (and (currstate t5) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_0)) )
...
(:action sync-p3_complete-ct7
:precondition (and (currstate t5) (currstate s_2_2) (not (currstate s_1_2)) (not (currstate s_1_0)) )
...
(:action sync-p3_complete-ct8
:precondition (and (currstate t5) (currstate s_1_2) (currstate s_2_2) )
...
:precondition (and (currstate t5) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_2_0)) )
