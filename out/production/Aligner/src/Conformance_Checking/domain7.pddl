...
:precondition (and (currstate t7) (not (currstate s_9_3)) (not (currstate s_9_2)) (not (currstate s_9_0)) )
...
:precondition (and (currstate t8) (not (currstate s_5_3)) (not (currstate s_5_2)) (not (currstate s_5_0)) )
...
:precondition (and (currstate t9) (not (currstate s_8_3)) (not (currstate s_8_2)) (not (currstate s_8_0)) )
...
:precondition (and (currstate t11) (not (currstate s_9_3)) (not (currstate s_9_2)) (not (currstate s_9_0)) )
...
:precondition (and (currstate t13) (not (currstate s_9_3)) (not (currstate s_9_2)) (not (currstate s_9_0)) )
...
:precondition (and (currstate t14) (not (currstate s_4_3)) (not (currstate s_4_2)) (not (currstate s_4_0)) )
...
:precondition (and (currstate t15) (not (currstate s_7_2)) (not (currstate s_7_0)) (not (currstate s_7_3)) )
...
:precondition (and (currstate t17) (not (currstate s_2_0)) (not (currstate s_2_3)) (not (currstate s_2_2)) )
