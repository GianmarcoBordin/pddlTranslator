...
:precondition (and (currstate t7) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_0)) )
...
(:action sync-p3_complete-ct6
:precondition (and (currstate t13) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_0)) )
...
:precondition (and (currstate t7) (currstate s_2_2) (not (currstate s_1_2)) (not (currstate s_1_0)) )
...
(:action sync-p3_complete-ct7
:precondition (and (currstate t13) (currstate s_2_2) (not (currstate s_1_2)) (not (currstate s_1_0)) )
...
:precondition (and (currstate t7) (currstate s_1_2) (currstate s_2_2) )
...
(:action sync-p3_complete-ct8
:precondition (and (currstate t13) (currstate s_1_2) (currstate s_2_2) )
...
:precondition (and (currstate t7) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_2_0)) )
...
:precondition (and (currstate t13) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_2_0)) )
