...
:precondition (and (currstate t2) (not (currstate s_0_0)) (not (currstate s_0_2)) (not (currstate s_0_0)) (not (currstate s_0_3)) (not (currstate s_0_2)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t3) (not (currstate s_0_0)) (not (currstate s_0_2)) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t6) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_0_2)) (not (currstate s_0_2)) (not (currstate s_0_0)) )
...
:precondition (and (currstate t7) (not (currstate s_0_0)) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_0_2)) (not (currstate s_0_2)) (not (currstate s_0_3)) )
