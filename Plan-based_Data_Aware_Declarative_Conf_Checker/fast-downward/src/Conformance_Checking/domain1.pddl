...
:precondition (and (currstate t0) (not (currstate s_0_0)) (not (currstate s_0_3)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t1) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t7) (not (currstate s_0_3)) (not (currstate s_0_2)) (not (currstate s_0_0)) )
...
:precondition (and (currstate t11) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_0_2)) )
