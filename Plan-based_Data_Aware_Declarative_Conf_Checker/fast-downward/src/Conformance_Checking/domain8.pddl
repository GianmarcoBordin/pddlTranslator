...
:precondition (and (currstate t15) (currstate s_2_2) (not (currstate s_0_3)) (not (currstate s_1_2)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t13) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t15) (not (currstate s_2_2)) (not (currstate s_0_3)) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_2_0)) )
...
:precondition (and (currstate t16) (not (currstate s_0_3)) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_0_0)) )
