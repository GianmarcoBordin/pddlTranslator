...
:precondition (and (currstate t4) (not (currstate s_0_3)) (not (currstate s_0_0)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t10) (not (currstate s_0_0)) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t16) (not (currstate s_0_2)) (not (currstate s_0_0)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t17) (not (currstate s_0_2)) (not (currstate s_0_0)) (not (currstate s_0_3)) )
