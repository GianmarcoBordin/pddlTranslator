...
:precondition (and (currstate t4) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_1_2)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t6) (not (currstate s_0_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t11) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t15) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_1_2)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t18) (not (currstate s_0_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_1_2)) )
