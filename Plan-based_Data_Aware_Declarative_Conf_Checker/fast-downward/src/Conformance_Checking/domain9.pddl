...
:precondition (and (currstate t11) (currstate s_2_2) (not (currstate s_0_3)) (not (currstate s_1_2)) (not (currstate s_0_2)) )
...
:precondition (and (currstate t4) (not (currstate s_0_3)) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_0_0)) )
...
:precondition (and (currstate t11) (not (currstate s_2_2)) (not (currstate s_0_3)) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_2_0)) )
...
:precondition (and (currstate t12) (not (currstate s_0_3)) (not (currstate s_0_2)) (not (currstate s_2_2)) (not (currstate s_1_2)) )
