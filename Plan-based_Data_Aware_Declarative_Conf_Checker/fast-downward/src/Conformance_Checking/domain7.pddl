...
:effect (and (not (currstate t39)) (currstate t40) (not (currstate s_7_3)) (currstate s_7_0) )
)
...
:effect (and (not (currstate t36)) (currstate t37) (not (currstate s_4_3)) (currstate s_4_0) )
)
...
:effect (and (not (currstate t43)) (currstate t44) (not (currstate s_2_3)) (currstate s_2_0) )
)
...
:effect (and (not (currstate t31)) (currstate t32) (not (currstate s_9_3)) (currstate s_9_0) )
)

(:action sync-p3_complete-ct73
:precondition (and (currstate t35) (currstate s_9_3) (not (currstate s_24_2)) (not (currstate s_23_2)) )
:effect (and (not (currstate t35)) (currstate t36) (not (currstate s_9_3)) (currstate s_9_0) )
)
...
:effect (and (not (currstate t22)) (currstate t23) (not (currstate s_5_3)) (currstate s_5_0) )
)
