...
:effect (and (not (currstate t5)) (currstate t6) (not (currstate s_0_3)) (currstate s_0_4) )
)

(:action sync-activityo_complete-ct2
:precondition (and (currstate t7) (currstate s_0_3) )
:effect (and (not (currstate t7)) (currstate t8) (not (currstate s_0_3)) (currstate s_0_4) )
)
...
:precondition (and (currstate t5) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_4)) (not (currstate s_0_0)) )
...
:precondition (and (currstate t7) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_4)) (not (currstate s_0_0)) )
