...
:precondition (and (currstate s_0_0) (not (currstate s_1_2)) )
:effect (and (not (currstate s_0_0)) (currstate s_0_2)  (increase (total-cost) 1))
)

(:action add-p3_start-ct1
...
(:action add-p3_start-ct2
:precondition (and (currstate s_0_2) (not (currstate s_1_2)) (not (currstate s_1_0)) )
...
(:action add-p3_complete-ct4
:precondition (and (currstate s_1_2) (not (currstate s_0_2)) )
:effect (and (not (currstate s_1_2)) (currstate s_1_0)  (increase (total-cost) 1))
)

(:action sync-p3_complete-ct4
:precondition (and (currstate t4) (currstate s_1_2) (not (currstate s_0_2)) )
:effect (and (not (currstate t4)) (currstate t5) (not (currstate s_1_2)) (currstate s_1_0) )
)

(:action sync-p3_complete-ct4
:precondition (and (currstate t5) (currstate s_1_2) (not (currstate s_0_2)) )
:effect (and (not (currstate t5)) (currstate t6) (not (currstate s_1_2)) (currstate s_1_0) )
)

(:action sync-p3_complete-ct4
:precondition (and (currstate t6) (currstate s_1_2) (not (currstate s_0_2)) )
...
:precondition (and (currstate t4) (not (currstate s_0_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t5) (not (currstate s_0_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t6) (not (currstate s_0_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
