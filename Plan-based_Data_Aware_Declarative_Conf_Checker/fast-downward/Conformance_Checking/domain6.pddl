...
(:action sync-b_start-ct21
:precondition (and (currstate t8) (currstate s_5_2) (not (currstate s_0_2)) (not (currstate s_2_3)) (not (currstate s_1_2)) (not (currstate s_1_3)) (not (currstate s_2_2)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t3) (currstate s_5_2) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) (not (currstate s_2_3)) )
...
(:action sync-b_complete-ct33
:precondition (and (currstate t9) (currstate s_5_0) (not (currstate s_0_2)) (not (currstate s_2_3)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) )
...
:precondition (and (currstate t2) (currstate s_5_2) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_1_3)) (not (currstate s_2_2)) (not (currstate s_2_3)) (not (currstate s_0_3)) )
...
(:action sync-d_start-t2t3
:precondition (and (currstate t2) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_1_3)) (not (currstate s_2_2)) (not (currstate s_5_2)) (not (currstate s_2_3)) (not (currstate s_0_3)) )
:effect (and (not (currstate t2)) (currstate t3)))

(:action del-d_start-t2-t3
:precondition (currstate t2)
:effect (and (not (currstate t2)) (currstate t3)  (increase (total-cost) 1))
)

(:action sync-d_complete-t3t4
:precondition (and (currstate t3) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_5_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) (not (currstate s_2_3)) )
:effect (and (not (currstate t3)) (currstate t4)))

(:action del-d_complete-t3-t4
...
(:action sync-b_start-t8t9
:precondition (and (currstate t8) (not (currstate s_0_2)) (not (currstate s_2_3)) (not (currstate s_1_2)) (not (currstate s_1_3)) (not (currstate s_2_2)) (not (currstate s_5_2)) (not (currstate s_0_3)) )
:effect (and (not (currstate t8)) (currstate t9)))

(:action del-b_start-t8-t9
:precondition (currstate t8)
:effect (and (not (currstate t8)) (currstate t9)  (increase (total-cost) 1))
)

(:action sync-b_complete-t9t10
:precondition (and (currstate t9) (not (currstate s_0_2)) (not (currstate s_2_3)) (not (currstate s_5_0)) (not (currstate s_1_2)) (not (currstate s_5_2)) (not (currstate s_2_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) )
:effect (and (not (currstate t9)) (currstate t10)))

(:action del-b_complete-t9-t10
