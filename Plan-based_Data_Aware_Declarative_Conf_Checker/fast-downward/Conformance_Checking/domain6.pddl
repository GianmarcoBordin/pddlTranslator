...
:precondition (and (currstate t15) (currstate s_1_2) (not (currstate s_0_2)) )
:effect (and (not (currstate t15)) (currstate t16) (not (currstate s_1_2)) (currstate s_1_0) )
)

(:action sync-p3_complete-ct4
:precondition (and (currstate t17) (currstate s_1_2) (not (currstate s_0_2)) )
...
:precondition (and (currstate t15) (not (currstate s_0_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t17) (not (currstate s_0_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t18) (not (currstate s_0_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
