...
:precondition (and (currstate t0) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) (not (currstate s_2_3)) )
...
:precondition (and (currstate t1) (not (currstate s_0_2)) (not (currstate s_2_3)) (not (currstate s_1_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) (not (currstate s_2_2)) )
