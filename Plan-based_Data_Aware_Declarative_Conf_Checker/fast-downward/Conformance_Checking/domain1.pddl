...
(:action sync-e_start-ct35
:precondition (and (currstate t22) (currstate s_5_2) (not (currstate s_2_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) (not (currstate s_2_3)) )
...
(:action sync-e_complete-ct36
:precondition (and (currstate t23) (currstate s_5_2) (not (currstate s_1_3)) (not (currstate s_2_2)) (not (currstate s_2_3)) (not (currstate s_0_3)) (not (currstate s_0_2)) (not (currstate s_1_2)) )
...
(:action sync-e_start-t22t23
:precondition (and (currstate t22) (not (currstate s_2_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) (not (currstate s_5_2)) (not (currstate s_0_3)) (not (currstate s_1_3)) (not (currstate s_2_3)) )
:effect (and (not (currstate t22)) (currstate t23)))

(:action del-e_start-t22-t23
:precondition (currstate t22)
:effect (and (not (currstate t22)) (currstate t23)  (increase (total-cost) 1))
)

(:action sync-e_complete-t23t24
:precondition (and (currstate t23) (not (currstate s_1_3)) (not (currstate s_2_2)) (not (currstate s_2_3)) (not (currstate s_0_3)) (not (currstate s_5_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) )
:effect (and (not (currstate t23)) (currstate t24)))

(:action del-e_complete-t23-t24
