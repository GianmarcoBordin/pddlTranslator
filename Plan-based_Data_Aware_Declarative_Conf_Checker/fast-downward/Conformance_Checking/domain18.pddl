...
:precondition (and (currstate t6) (currstate s_2_2) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_1_3)) (not (currstate s_0_3)) )
...
:precondition (and (currstate t7) (currstate s_2_3) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_1_2)) (not (currstate s_1_3)) )
...
:precondition (and (currstate t6) (not (currstate s_2_2)) (not (currstate s_2_0)) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_1_3)) (not (currstate s_0_3)) (not (currstate s_2_3)) )
...
:precondition (and (currstate t7) (not (currstate s_2_0)) (not (currstate s_2_3)) (not (currstate s_0_2)) (not (currstate s_2_2)) (not (currstate s_0_3)) (not (currstate s_1_2)) (not (currstate s_1_3)) )
