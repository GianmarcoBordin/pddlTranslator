...
public class H_MenuPerspective {
	...
	public H_MenuPerspective() {
	}


	public void importXes(ActionEvent e) {
		...
		int returnValue = fileChooser.showOpenDialog(Container.getDesktop());
		if (returnValue == JFileChooser.APPROVE_OPTION) {
			File selectedFile = fileChooser.getSelectedFile();
			// System.out.println(selectedFile.getName());

			try {
				Container.setActivitiesRepository_vector(new Vector<String>());
				Container.setAllTraces_vector(new Vector<Trace>());
				...
				Container.getImportMenu().setEnabled(false);
				Container.getImportDeclareMenuItem().setEnabled(false);
				/////////////////// ModelLearning ////////////////////
				//////////////////////////////////////////////////////
				Container.getImportModelLearningAutomatonMenuItem().setEnabled(false);
				//////////////////////////////////////////////////////
				//////////////////////////////////////////////////////

				/////////////////// DataAware ////////////////////////
				//////////////////////////////////////////////////////
				Container.getimportDataAwareListMenuItem().setEnabled(false);
				//////////////////////////////////////////////////////
				//////////////////////////////////////////////////////
	...
	public void importDot(ActionEvent e) {
