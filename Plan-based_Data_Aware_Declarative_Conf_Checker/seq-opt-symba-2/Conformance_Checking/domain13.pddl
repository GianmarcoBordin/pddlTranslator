...
:precondition (and (currstate t7) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t14) (not (currstate s_1_2)) (not (currstate s_0_2)) (not (currstate s_0_2)) (not (currstate s_1_2)) )
