...
(:action sync-p8-ct13
:precondition (and (currstate t6) (currstate s_0_6) )
:effect (and (not (currstate t6)) (currstate t7) (not (currstate s_0_6)) (currstate s_0_1) )
)
...
(:action sync-p8-t6t7
:precondition (and (currstate t6) (not (currstate s_0_4)) (not (currstate s_0_6)) (not (currstate s_0_13)) (not (currstate s_0_8)) (not (currstate s_0_12)) (not (currstate s_0_10)) (not (currstate s_0_7)) (not (currstate s_0_2)) (not (currstate s_0_11)) (not (currstate s_0_3)) (not (currstate s_0_9)) )
...
(:action sync-activityp-t13t14
:precondition (and (currstate t13) (not (currstate s_0_10)) (not (currstate s_0_9)) (not (currstate s_0_2)) (not (currstate s_0_13)) (not (currstate s_0_7)) (not (currstate s_0_11)) (not (currstate s_0_8)) (not (currstate s_0_12)) (not (currstate s_0_4)) )
:effect (and (not (currstate t13)) (currstate t14)))

(:action del-activityp-t13-t14
...
(:action sync-activityl-t16t17
:precondition (and (currstate t16) (not (currstate s_0_10)) (not (currstate s_0_8)) (not (currstate s_0_12)) (not (currstate s_0_9)) (not (currstate s_0_2)) (not (currstate s_0_7)) (not (currstate s_0_11)) (not (currstate s_0_4)) (not (currstate s_0_13)) )
:effect (and (not (currstate t16)) (currstate t17)))

(:action del-activityl-t16-t17
:precondition (currstate t16)
:effect (and (not (currstate t16)) (currstate t17)  (increase (total-cost) 1))
)

(:action sync-activityl-t17t18
:precondition (and (currstate t17) (not (currstate s_0_10)) (not (currstate s_0_8)) (not (currstate s_0_12)) (not (currstate s_0_9)) (not (currstate s_0_2)) (not (currstate s_0_7)) (not (currstate s_0_11)) (not (currstate s_0_4)) (not (currstate s_0_13)) )
:effect (and (not (currstate t17)) (currstate t18)))

(:action del-activityl-t17-t18
...
(:action sync-activityp-t19t20
:precondition (and (currstate t19) (not (currstate s_0_10)) (not (currstate s_0_9)) (not (currstate s_0_2)) (not (currstate s_0_13)) (not (currstate s_0_7)) (not (currstate s_0_11)) (not (currstate s_0_8)) (not (currstate s_0_12)) (not (currstate s_0_4)) )
:effect (and (not (currstate t19)) (currstate t20)))

(:action del-activityp-t19-t20
