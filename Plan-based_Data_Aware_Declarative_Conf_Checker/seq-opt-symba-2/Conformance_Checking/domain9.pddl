...
:precondition (and (currstate t11) (currstate s_3_0) (not (currstate s_6_2)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t9) (currstate s_3_0) (not (currstate s_6_2)) (not (currstate s_2_2)) )
...
(:action sync-activityrcomplete-t9t10
:precondition (and (currstate t9) (not (currstate s_3_0)) (not (currstate s_6_2)) (not (currstate s_2_2)) )
:effect (and (not (currstate t9)) (currstate t10)))

(:action del-activityrcomplete-t9-t10
:precondition (currstate t9)
:effect (and (not (currstate t9)) (currstate t10)  (increase (total-cost) 1))
)

(:action sync-p4complete-t10t11
