...
(:action sync-p13complete-ct43
:precondition (and (currstate t15) (currstate s_6_2) (not (currstate s_3_0)) (not (currstate s_2_2)) )
...
(:action sync-p13complete-ct44
:precondition (and (currstate t15) (currstate s_3_0) (currstate s_6_2) (not (currstate s_2_2)) )
...
:precondition (and (currstate t16) (currstate s_3_0) (currstate s_6_2) (not (currstate s_2_2)) )
:effect (and (not (currstate t16)) (currstate t17) (not (currstate s_3_0)) (currstate s_3_2) (not (currstate s_6_2)) (currstate s_6_0) )
)
...
(:action del-p8complete-t14-t15
:precondition (currstate t14)
:effect (and (not (currstate t14)) (currstate t15)  (increase (total-cost) 1))
)

(:action sync-p13complete-t15t16
:precondition (and (currstate t15) (not (currstate s_3_0)) (not (currstate s_2_2)) (not (currstate s_6_2)) )
:effect (and (not (currstate t15)) (currstate t16)))

(:action del-p13complete-t15-t16
:precondition (currstate t15)
:effect (and (not (currstate t15)) (currstate t16)  (increase (total-cost) 1))
)

(:action sync-activityrcomplete-t16t17
:precondition (and (currstate t16) (not (currstate s_3_0)) (not (currstate s_6_2)) (not (currstate s_2_2)) )
:effect (and (not (currstate t16)) (currstate t17)))

(:action del-activityrcomplete-t16-t17
