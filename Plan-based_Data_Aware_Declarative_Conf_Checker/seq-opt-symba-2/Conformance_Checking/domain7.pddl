...
(:action sync-p13complete-ct56
:precondition (and (currstate t15) (currstate s_7_3) )
...
:precondition (and (currstate t14) (currstate s_4_3) )
...
(:action sync-activityrcomplete-ct86
...
:precondition (and (currstate t2) (not (currstate s_0_2)) (not (currstate s_0_3)) (not (currstate s_0_4)) (not (currstate s_0_0)) )
...
:precondition (and (currstate t6) (not (currstate s_1_2)) (not (currstate s_1_4)) (not (currstate s_1_3)) (not (currstate s_1_0)) )
...
:precondition (and (currstate t14) (not (currstate s_4_3)) (not (currstate s_4_0)) (not (currstate s_4_4)) (not (currstate s_4_2)) )
...
:precondition (and (currstate t15) (not (currstate s_7_2)) (not (currstate s_7_4)) (not (currstate s_7_3)) (not (currstate s_7_0)) )
...
:precondition (and (currstate t16) (not (currstate s_16_2)) (not (currstate s_16_3)) (not (currstate s_16_0)) (not (currstate s_16_4)) )
