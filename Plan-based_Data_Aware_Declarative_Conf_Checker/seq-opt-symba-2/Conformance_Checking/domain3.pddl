...
:precondition (and (currstate t3) (not (currstate s_10_2)) (not (currstate s_10_4)) (not (currstate s_10_3)) (not (currstate s_10_0)) )
...
:precondition (and (currstate t6) (not (currstate s_12_0)) (not (currstate s_12_4)) (not (currstate s_12_2)) (not (currstate s_12_3)) )
...
:precondition (and (currstate t7) (not (currstate s_8_4)) (not (currstate s_8_2)) (not (currstate s_8_3)) (not (currstate s_8_0)) )
...
:precondition (and (currstate t8) (not (currstate s_16_2)) (not (currstate s_16_3)) (not (currstate s_16_0)) (not (currstate s_16_4)) )
...
:precondition (and (currstate t19) (not (currstate s_4_3)) (not (currstate s_4_0)) (not (currstate s_4_4)) (not (currstate s_4_2)) )
