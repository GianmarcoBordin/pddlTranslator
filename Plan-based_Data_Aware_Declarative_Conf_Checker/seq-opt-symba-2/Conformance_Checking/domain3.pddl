...
:precondition (and (currstate t4) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t6) (not (currstate s_2_2)) (not (currstate s_2_2)) (not (currstate s_1_2)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t7) (not (currstate s_2_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t10) (not (currstate s_1_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_2_2)) )
