...
(:action sync-p13complete-ct43
:precondition (and (currstate t9) (currstate s_6_2) (not (currstate s_3_0)) (not (currstate s_2_2)) )
...
(:action sync-p13complete-ct44
:precondition (and (currstate t9) (currstate s_3_0) (currstate s_6_2) (not (currstate s_2_2)) )
:effect (and (not (currstate t9)) (currstate t10) (not (currstate s_3_0)) (currstate s_3_2) (not (currstate s_6_2)) (currstate s_6_0) )
)
...
(:action add-p6complete-ct94
:precondition (and (currstate s_3_0) (not (currstate s_2_2)) (not (currstate s_6_2)) )
:effect (and (not (currstate s_3_0)) (currstate s_3_2)  (increase (total-cost) 1))
)

(:action sync-p6complete-ct94
...
(:action add-p6complete-ct95
:precondition (and (currstate s_6_2) (not (currstate s_3_0)) (not (currstate s_2_2)) )
:effect (and (not (currstate s_6_2)) (currstate s_6_0)  (increase (total-cost) 1))
)

(:action sync-p6complete-ct95
:precondition (and (currstate t11) (currstate s_6_2) (not (currstate s_3_0)) (not (currstate s_2_2)) )
:effect (and (not (currstate t11)) (currstate t12) (not (currstate s_6_2)) (currstate s_6_0) )
)

(:action add-p6complete-ct96
:precondition (and (currstate s_3_0) (currstate s_6_2) (not (currstate s_2_2)) )
:effect (and (not (currstate s_3_0)) (currstate s_3_2) (not (currstate s_6_2)) (currstate s_6_0)  (increase (total-cost) 1))
)

(:action sync-p6complete-ct96
:precondition (and (currstate t11) (currstate s_3_0) (currstate s_6_2) (not (currstate s_2_2)) )
...
:precondition (and (currstate t13) (currstate s_3_0) (not (currstate s_6_2)) (not (currstate s_2_2)) )
...
(:action sync-p13complete-t9t10
:precondition (and (currstate t9) (not (currstate s_3_0)) (not (currstate s_2_2)) (not (currstate s_6_2)) )
:effect (and (not (currstate t9)) (currstate t10)))

(:action del-p13complete-t9-t10
...
(:action sync-p6complete-t11t12
:precondition (and (currstate t11) (not (currstate s_3_0)) (not (currstate s_2_2)) (not (currstate s_6_2)) )
:effect (and (not (currstate t11)) (currstate t12)))

(:action del-p6complete-t11-t12
:precondition (currstate t11)
:effect (and (not (currstate t11)) (currstate t12)  (increase (total-cost) 1))
)

(:action sync-p4complete-t12t13
...
(:action del-p4complete-t12-t13
:precondition (currstate t12)
:effect (and (not (currstate t12)) (currstate t13)  (increase (total-cost) 1))
)

(:action sync-p5complete-t13t14
:precondition (and (currstate t13) (not (currstate s_3_0)) (not (currstate s_6_2)) (not (currstate s_2_2)) )
:effect (and (not (currstate t13)) (currstate t14)))

(:action del-p5complete-t13-t14
