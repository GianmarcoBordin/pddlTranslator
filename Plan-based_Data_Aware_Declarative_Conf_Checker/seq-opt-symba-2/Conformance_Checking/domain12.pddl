...
:precondition (and (currstate t2) (currstate s_3_0) (not (currstate s_6_2)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t2) (currstate s_6_2) (not (currstate s_3_0)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t2) (currstate s_3_0) (currstate s_6_2) (not (currstate s_2_2)) )
...
:precondition (and (currstate t2) (not (currstate s_3_0)) (not (currstate s_6_2)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t11) (not (currstate s_6_2)) (not (currstate s_3_0)) (not (currstate s_2_2)) )
