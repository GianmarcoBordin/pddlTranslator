...
:precondition (and (currstate t2) (not (currstate s_2_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t17) (not (currstate s_1_2)) (not (currstate s_2_2)) (not (currstate s_2_2)) (not (currstate s_1_2)) )
