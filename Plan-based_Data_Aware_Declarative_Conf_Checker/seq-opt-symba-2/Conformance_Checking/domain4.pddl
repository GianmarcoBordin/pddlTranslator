...
:precondition (and (currstate t0) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_2)) )
...
(:action sync-p3_complete-ct12
:precondition (and (currstate t10) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_2)) )
:effect (and (not (currstate t10)) (currstate t11) (not (currstate s_1_2)) (currstate s_1_0) )
)

(:action sync-p3_complete-ct12
:precondition (and (currstate t14) (currstate s_1_2) (not (currstate s_2_2)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t0) (not (currstate s_2_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t3) (not (currstate s_2_2)) (not (currstate s_1_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t9) (not (currstate s_2_2)) (not (currstate s_1_2)) (not (currstate s_1_2)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t10) (not (currstate s_2_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
...
:precondition (and (currstate t14) (not (currstate s_2_2)) (not (currstate s_2_2)) (not (currstate s_1_0)) (not (currstate s_1_2)) )
