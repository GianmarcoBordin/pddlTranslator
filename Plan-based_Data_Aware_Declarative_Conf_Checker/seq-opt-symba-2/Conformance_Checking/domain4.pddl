...
:precondition (and (currstate t5) (currstate s_6_2) (not (currstate s_3_0)) (not (currstate s_2_2)) )
...
:precondition (and (currstate t5) (currstate s_3_0) (currstate s_6_2) (not (currstate s_2_2)) )
:effect (and (not (currstate t5)) (currstate t6) (not (currstate s_3_0)) (currstate s_3_2) (not (currstate s_6_2)) (currstate s_6_0) )
)
...
(:action del-p10complete-t4-t5
:precondition (currstate t4)
:effect (and (not (currstate t4)) (currstate t5)  (increase (total-cost) 1))
)

(:action sync-p13complete-t5t6
:precondition (and (currstate t5) (not (currstate s_3_0)) (not (currstate s_2_2)) (not (currstate s_6_2)) )
:effect (and (not (currstate t5)) (currstate t6)))

(:action del-p13complete-t5-t6
...
(:action sync-p20complete-t19t20
:precondition (and (currstate t19) (not (currstate s_3_0)) (not (currstate s_2_2)) (not (currstate s_6_2)) )
:effect (and (not (currstate t19)) (currstate t20)))

(:action del-p20complete-t19-t20
