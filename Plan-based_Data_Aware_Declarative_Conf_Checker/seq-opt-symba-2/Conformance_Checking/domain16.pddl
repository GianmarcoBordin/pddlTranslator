...
:precondition (and (currstate t9) (currstate s_2_0) (not (currstate s_5_2)) (not (currstate s_10_2)) (not (currstate s_1_2)) (not (currstate s_11_2)) )
...
:precondition (and (currstate t9) (currstate s_5_2) (currstate s_2_0) (not (currstate s_10_2)) (not (currstate s_1_2)) (not (currstate s_11_2)) )
...
:precondition (and (currstate t9) (not (currstate s_5_2)) (not (currstate s_10_2)) (not (currstate s_1_2)) (not (currstate s_2_0)) (not (currstate s_11_2)) )
