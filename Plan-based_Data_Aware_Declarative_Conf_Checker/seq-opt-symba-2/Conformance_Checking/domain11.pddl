...
(:action sync-activityrcomplete-ct162
:precondition (and (currstate t17) (currstate s_3_0) (not (currstate s_6_2)) (not (currstate s_2_2)) )
...
(:action sync-activityrcomplete-t6t7
...
(:action del-activityrcomplete-t6-t7
...
(:action sync-activityncomplete-t10t11
...
(:action del-activityncomplete-t10-t11
...
(:action sync-activityrcomplete-t17t18
:precondition (and (currstate t17) (not (currstate s_3_0)) (not (currstate s_6_2)) (not (currstate s_2_2)) )
:effect (and (not (currstate t17)) (currstate t18)))

(:action del-activityrcomplete-t17-t18
