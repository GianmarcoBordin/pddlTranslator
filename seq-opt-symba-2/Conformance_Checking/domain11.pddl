...
(:action sync-activityn-t10t11
:precondition (and (currstate t10) (not (currstate s_0_7)) (not (currstate s_0_9)) (not (currstate s_0_10)) (not (currstate s_0_11)) (not (currstate s_0_4)) (not (currstate s_0_2)) (not (currstate s_0_8)) (not (currstate s_0_12)) (not (currstate s_0_13)) )
:effect (and (not (currstate t10)) (currstate t11)))

(:action del-activityn-t10-t11
